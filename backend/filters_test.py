...
class FiltersTest(TestCase):
    ...
    def test_filter_plot_options_with_samplerate(self):
        self.assertEqual(
            filter_plot_options(
    ...
    def test_filter_plot_options_with_channels(self):
        self.assertEqual(
            filter_plot_options(
                ["filter_44100_2", "filter_44100_8", "filter_48000_2", "filter_48000_8"],
    ...
    def test_filter_plot_options_with_samplerate_and_channels(self):
        self.assertEqual(
            filter_plot_options(
                ["filter_44100_2", "filter_44100_8", "filter_48000_2", "filter_48000_8"],
    ...
    def test_filter_plot_options_without_samplerate_and_channels(self):
        self.assertEqual(
            filter_plot_options(
                ["filter_44100_2", "filter_44100_8", "filter_48000_2", "filter_48000_8"],
                "filter_44100_2"
    ...
    def test_filter_plot_options_handles_filenames_with_brackets(self):
        self.assertEqual(
            filter_plot_options(
                [
                    "filter_((44100)_(2))",
    ...
    def test_pipeline_step_plot_options_for_only_one_samplerate_and_channel_option(self):
        config = {
            "devices": {
                "samplerate": 44100,
                "capture": {"channels": 2}
        ...
        self.assertEqual(
            pipeline_step_plot_options(filter_file_names, config, 0),
            [{"name": "44100 Hz - 2 Channels", "samplerate": 44100, "channels": 2}]
        )

    def test_pipeline_step_plot_options_for_many_samplerate_and_channel_options(self):
        config = {
            "devices": {
                "samplerate": 44100,
                "capture": {"channels": 2}
